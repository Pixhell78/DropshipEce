...
<div class="container-fluid text-center">    
  ...
  if($db_found){
        ...
        $sql_count = mysqli_query($db_handle,"SELECT COUNT(*) AS titre FROM livre WHERE genre='roman'") or exit(mysql_error());
    ...
    for($i=1;$i<=$num;$i++) {
        ...
        $sql = "SELECT * FROM livre WHERE genre='roman' AND id=$i" ;
