...
<div class="container-fluid text-center">    
  ...
  if($db_found){
        ...
        $sql_count = mysqli_query($db_handle,"SELECT COUNT(*) AS titre FROM musique WHERE genre='rap'") or exit(mysql_error());
    ...
    for($i=1;$i<=$num;$i++) {
        ...
        $sql = "SELECT * FROM musique WHERE genre='rap' AND id=$i" ;
