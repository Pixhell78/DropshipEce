...
<div class="container-fluid text-center">    
  ...
  if($db_found){
        ...
        $sql_count = mysqli_query($db_handle,"SELECT COUNT(*) AS titre FROM vetement WHERE genre='homme'") or exit(mysql_error());
    ...
    for($i=1;$i<=$num;$i++) {
        ...
        $sql = "SELECT * FROM vetement WHERE genre='homme' AND id=$i" ;
