...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      <p><a href="musiquezouk.php">Zouk</a></p>
  ...
  if($db_found){
        ...
        $sql_count = mysqli_query($db_handle,"SELECT COUNT(*) AS titre FROM musique WHERE genre='dancehall'") or exit(mysql_error());
    ...
    for($i=1;$i<=$num;$i++) {
        ...
        $sql = "SELECT * FROM musique WHERE genre='dancehall' AND id=$i" ;
