...
<div class="container-fluid text-center">    
  ...
  if($db_found){
        ...
        $sql_count = mysqli_query($db_handle,"SELECT COUNT(*) AS titre FROM sportloisir WHERE genre='sport'") or exit(mysql_error());
    ...
    for($i=1;$i<=$num;$i++) {
        ...
        $sql = "SELECT * FROM sportloisir WHERE genre='sport' AND id=$i" ;
